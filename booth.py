...
def UpdateDisplay():
	...
	SmallText = "HALLOWEEN 2017" #Default small message text   
...
def main(threadName, *args):
	...
	while closeme:
		...
		# if True == True:
			...
			im2 = PIL.Image.open(os.path.join(imagefolder,filename)).transpose(Image.FLIP_LEFT_RIGHT).transpose(Image.ROTATE_90)
			...
			im3 = PIL.Image.open(os.path.join(imagefolder,filename)).transpose(Image.FLIP_LEFT_RIGHT).transpose(Image.ROTATE_90)
			...
			im4 = PIL.Image.open(os.path.join(imagefolder,filename)).transpose(Image.FLIP_LEFT_RIGHT).transpose(Image.ROTATE_90)
			...
			# template_test3 WORKS1
			# bgimage = PIL.Image.open("/home/pi/Desktop/template_test3.jpg")
			bgimage = PIL.Image.open("/home/pi/Desktop/template_text.jpg")			
			...
			# WORKS1 WITH TEMPLATE TEST 3
			# bgimage.paste(im,(0,1280))
			# bgimage.paste(im2,(0,0))
			# bgimage.paste(im3,(720,1280))
			# bgimage.paste(im4,(720,0))

			bgimage.paste(im,(0,1300))
                        bgimage.paste(im2,(0,20))
                        bgimage.paste(im3,(720,1300))
                        bgimage.paste(im4,(720,20))			
